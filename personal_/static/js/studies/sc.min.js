...
$(document).ready(function () {
  ...
  $("[data-question=question0]").attr('disabled', 'true')
  // $(".previos-bttn").each((i, e)=>{
  //   if ($(e).attr("data-question") == "question0") {
  //     $(e).attr("disabled", "true");
  //     return;
  //   }
  // })
    $(".previos-bttn").on("click", function () {
      var previous_bttn_id = $(this).attr("data-question");
      $(".question-div .card-body").fadeOut(0);
      $(".question-div #" + previous_bttn_id).fadeIn(500);
      // alert(next_bttn_id);
      // $(this).addClass('active');
      return false;
    });
