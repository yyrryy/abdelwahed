...
const past = [
  {
    ...
    u: [["Finished actions in the past.", "I went to the cinema yesterday."]],
  },

  {
    ...
    u: [
      [
        "refer to something that happened more in the past than something else.",
...
const exercices = [
  ...
  },
  {
    ...
    e: [
      "him being in the hospital is an action that starts in the past and didn't finish yet (there is a 'for' indicator",
      "zxpl for would",
    ],
  },
  {
...
exercices.map((ex, i) => {
  expl = [];
  for (let j = 0; j < ex.e.length; j++) {
    expl.push(`<li>${ex.h[j]}: ${ex.e[j]}</li>`);
  }
  exholder.append(`
        <div>
            <p>${i + 1}. ${ex.q}  <span class="text-primary">(${ex.ch.join(
    ", "
  )})</span></p>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tabs">
                            <div class="tab">
                                ...
                                <label class="tab-label" for="expl${i}">explanation</label>
                                <div class="tab-content">
                                    ${expl.join("<br>")}
                                </div>
                            </div>
